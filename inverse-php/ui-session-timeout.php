...
<body class="skin-default fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Session Timeout</h4>
                    </div>
    ...
    <!-- Session-timeout -->
    <script src="../assets/node_modules/session-timeout/jquery.sessionTimeout.min.js"></script>
    <script src="../assets/node_modules/session-timeout/session-timeout-init.js"></script>
</body>
