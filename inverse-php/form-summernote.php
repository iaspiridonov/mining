            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Summernote</h4>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button id="edit" class="btn btn-info btn-rounded text-white" onclick="edit()" type="button">Edit</button>
                                <button id="save" class="btn btn-success btn-rounded text-white" onclick="save()" type="button">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
