                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-now-custom-1" class="form-label">You can add a default value</label>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-now-custom-2" class="form-label">You can set the height</label>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-now-custom-3" class="form-label">You can combine options</label>
                                <input type="file" id="input-file-now-custom-3" class="dropify" data-height="500" data-default-file="../assets/node_modules/dropify/src/images/test-image-2.jpg" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-max-fs" class="form-label">You can add a max file size</label>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-disable-remove" class="form-label">You can disable remove button</label>
