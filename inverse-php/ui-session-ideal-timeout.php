...
<body class="skin-default fixed-layout">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Session Idle Timeout</h4>
                    </div>
    ...
    <script src="../assets/node_modules/session-timeout/idle/jquery.idletimeout.js"></script>
    <script src="../assets/node_modules/session-timeout/idle/jquery.idletimer.js"></script>
    <script src="../assets/node_modules/session-timeout/idle/session-timeout-idle-init.js"></script>
</body>
